 ...
 * <p>
 * Levtus is a high-performance, zero-dependency HTTP/1.1 server designed to leverage 
 * Java Virtual Threads for efficient concurrency. It provides a fluent API for 
 * defining routes, middleware, and server configurations.
 */
public class Levtus {
    ...
    /**
     * Sets the maximum number of concurrent connections the server will accept.
     * This acts as a global throttle to protect system resources.
     *
