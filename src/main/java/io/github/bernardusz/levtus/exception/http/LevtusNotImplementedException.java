 ...
 *
 * <p>Results in an HTTP {@code 501 Not Implemented} response. Extended from: {@link
 * LevtusHttpException}
 */
public class LevtusNotImplementedException extends LevtusHttpException {
  /**
   * Constructs a new {@code LevtusNotImplementedException} with the specified message and the
   * status code of 501.
   *
